...
在 React Native 中，你可以定义一个函数（或类）来创建一个可复用的组件，
然后使用 `props` 方法来设置或者返回属性或者所选元素的值。
...
| [`FlatList`](https://reactnative.dev/docs/flatlist)                    | [`ListView.builder`][]               | 根据需要创建的一组 widget 的构造函数。
...
| [`Image`](https://reactnative.dev/docs/image)                         | [`Image`][]                                           | 显示图片的 widget。                                                                                                                     |
...
| [`Modal`](https://reactnative.dev/docs/modal)                          | [`ModalRoute`][]                                | 避免和之前路径交叉的路径。                                                                                                               |
...
|  [`ActivityIndicator`](https://reactnative.dev/docs/activityindicator) | [`CircularProgressIndicator`][] | 一个圆形进度条 widget。                                                                                                                 |
...
|  [`ActivityIndicator`](https://reactnative.dev/docs/activityindicator) | [`LinearProgressIndicator`][]     | 一个水平条形的进度条。                                                                                                                 |
...
| [`RefreshControl`](https://reactnative.dev/docs/refreshcontrol)        | [`RefreshIndicator`][]                   | 支持 Material 中滑动刷新的 widget                                                                                                       |
...
| [`TextInput`](https://reactnative.dev/docs/textinput)                | [`TextInput`][]                                   | 调用系统文本输入的接口。                                                                                                                      |
...
| [`Text`](https://reactnative.dev/docs/text)                          | [`Text`][]                                            | 以单一的样式显示文本的文本 widget。                                                                                                                                                                                                             |
