...
（上图 alt：Crossword Companion 应用界面，展示从选择填字图像开始的 5 步设置流程。）

好消息是，就像你可以用开发者工具为写代码的 AI 建立护栏一样，你也可以用 Flutter 为实现功能的 AI 建立护栏。[Crossword Companion 应用][crossword-app] 就是为了演示这些技术而构建的。
...
（上图 alt：Crossword Companion 应用显示 5×5 网格，设置错误显示为 4 行 5 列。）
