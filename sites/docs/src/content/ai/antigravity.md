...
description: 了解 Google Antigravity 智能体编程助手。
ai-translated: true
---
...
Google Antigravity 是一套基于 Agent 的开发工具套件，
可用于构建应用（包括 Flutter 应用）。
...
本指南介绍了 Antigravity IDE。
相关命令行工具的使用详情，
请参阅 [Antigravity CLI](/ai/antigravity-cli) 页面。
