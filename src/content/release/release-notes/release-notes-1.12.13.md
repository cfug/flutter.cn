...
[1370]({{site.repo.organization}}plugins/pull/1370) [camera] Pause/resume video recording for Android & iOS

[1999]({{site.repo.organization}}plugins/pull/1999) [Connectivity] add a method to request location on iOS (for iOS 13)

[2052]({{site.repo.organization}}plugins/pull/2052) [instrumentation_adapter] Add stub iOS implementation and example app

[2068]({{site.repo.organization}}plugins/pull/2068) [google_maps_flutter] Fix iOS MyLocationButton on iOS

[2083]({{site.repo.organization}}plugins/pull/2083) [image_picker] Fix a crash when picking video on iOS 13 and above.

[2131]({{site.repo.organization}}plugins/pull/2131) [share]fix iOS crash when setting the subject to null

[2139]({{site.repo.organization}}plugins/pull/2139) [google_maps_flutter] Add NonNull macro to reduce warnings in iOS

[2191]({{site.repo.organization}}plugins/pull/2191) [image_picker] Fix iOS build and analyzer warnings

[2192]({{site.repo.organization}}plugins/pull/2192) [in_app_purchase] Fix iOS build warning

[2275]({{site.repo.organization}}plugins/pull/2275) Update cirrus to create IOS simulator on 13.2 an xCode 11

[2281]({{site.repo.organization}}plugins/pull/2281) [connectivity] Fix reachability stream for iOS
...
[2003]({{site.repo.organization}}plugins/pull/2003) [video_player] Added formatHint to to override video format on Android

[2029]({{site.repo.organization}}plugins/pull/2029) fix android crash when pausing or resuming video on APIs lower than 24.

[2049]({{site.repo.organization}}plugins/pull/2049) [path_provider] Android: Support multiple external storage options

[2208]({{site.repo.organization}}plugins/pull/2208) delete all example/android/app/gradle.properties files

[2216]({{site.repo.organization}}plugins/pull/2216) [battery]Use android.arch.lifecycle instead of androidx.lifecycle:lifecycle in

[2239]({{site.repo.organization}}plugins/pull/2239) [camera] Android: Improve image streaming by creating a request suita…
...
[2232]({{site.repo.organization}}plugins/pull/2232) [multiple] V2 embedding plugins use compileOnly
...
[509]({{site.repo.organization}}cocoon/pull/509) Force the phone's screen on before running a test.
...
[2142]({{site.repo.organization}}plugins/pull/2142) [Connectivity] migrate to the new android embedding

[2152]({{site.repo.organization}}plugins/pull/2152) [battery] Support the v2 Android embedder

[2155]({{site.repo.organization}}plugins/pull/2155) [in_app_purchase] migrate to the v2 android embedding

[2156]({{site.repo.organization}}plugins/pull/2156) [Share] Support v2 android embedder.

[2157]({{site.repo.organization}}plugins/pull/2157) [url_launcher] Migrate to the new embedding

[2160]({{site.repo.organization}}plugins/pull/2160) [package_info] Support the v2 Android embedder (with e2e tests)

[2162]({{site.repo.organization}}plugins/pull/2162) [shared_preferences] Support v2 android embedder.

[2163]({{site.repo.organization}}plugins/pull/2163) [device_info] Support v2 android embedder.

[2164]({{site.repo.organization}}plugins/pull/2164) [sensor] Support v2 android embedder.

[2165]({{site.repo.organization}}plugins/pull/2165) [camera] Migrate to the new embedding

[2167]({{site.repo.organization}}plugins/pull/2167) [quick_actions] Support v2 android embedder.

[2169]({{site.repo.organization}}plugins/pull/2169) [flutter_webview] Migrate to the new embedding

[2193]({{site.repo.organization}}plugins/pull/2193) [android_alarm_manager] migrate to the V2 Android embedding

[2195]({{site.repo.organization}}plugins/pull/2195) [android_intent] Cleanup the V2 migration

[2196]({{site.repo.organization}}plugins/pull/2196) [webview_flutter] (Trivial) Add V2 warnings

[2200]({{site.repo.organization}}plugins/pull/2200) [flutter_webview] Revert v2 embedder support

[2204]({{site.repo.organization}}plugins/pull/2204) [url_launcher] Re-land v2 embedding support

[2209]({{site.repo.organization}}plugins/pull/2209) [webview_flutter] Re-land support v2 embedding support

[2226]({{site.repo.organization}}plugins/pull/2226) [video_player] Add v2 embedding support

[2241]({{site.repo.organization}}plugins/pull/2241) [Shared_preferences]suppress warnings

[2284]({{site.repo.organization}}plugins/pull/2284) [path_provider] Add v2 embedding support for

[2327]({{site.repo.organization}}plugins/pull/2327) [android_alarm_manager] Update minimum Flutter version to 1.12.0
...
[2087]({{site.repo.organization}}plugins/pull/2087) [android_alarm_manager] Update and migrate iOS example project

[2088]({{site.repo.organization}}plugins/pull/2088) [android_intent] Update and migrate iOS example project

[2089]({{site.repo.organization}}plugins/pull/2089) [battery] Update and migrate iOS example project

[2090]({{site.repo.organization}}plugins/pull/2090) [camera] Update and migrate iOS example project

[2091]({{site.repo.organization}}plugins/pull/2091) [connectivity] Update and migrate iOS example project

[2092]({{site.repo.organization}}plugins/pull/2092) [device_info] Update and migrate iOS example project

[2093]({{site.repo.organization}}plugins/pull/2093) [google_maps_flutter] Update and migrate iOS example project

[2094]({{site.repo.organization}}plugins/pull/2094) [google_sign_in] Update and migrate iOS example project

[2095]({{site.repo.organization}}plugins/pull/2095) [image_picker] Update and migrate iOS example project

[2096]({{site.repo.organization}}plugins/pull/2096) [in_app_purchase] Update and migrate iOS example project

[2097]({{site.repo.organization}}plugins/pull/2097) [local_auth] Update and migrate iOS example project

[2098]({{site.repo.organization}}plugins/pull/2098) [package_info] Update and migrate iOS example project

[2099]({{site.repo.organization}}plugins/pull/2099) [path_provider] Update and migrate iOS example project

[2100]({{site.repo.organization}}plugins/pull/2100) [quick_actions] Update and migrate iOS example project

[2101]({{site.repo.organization}}plugins/pull/2101) [sensors] Update and migrate iOS example project

[2102]({{site.repo.organization}}plugins/pull/2102) [share] Update and migrate iOS example project

[2103]({{site.repo.organization}}plugins/pull/2103) [shared_preferences] Update and migrate iOS example project

[2109]({{site.repo.organization}}plugins/pull/2109) [url_launcher] Update and migrate iOS example project

[2110]({{site.repo.organization}}plugins/pull/2110) [video_player] Update and migrate iOS example project

[2115]({{site.repo.organization}}plugins/pull/2115) [camera] Define clang modules in for iOS

[2125]({{site.repo.organization}}plugins/pull/2125) [in_app_purchase] Define clang module for iOS

[2128]({{site.repo.organization}}plugins/pull/2128) [image_picker] Define clang module for iOS

[2135]({{site.repo.organization}}plugins/pull/2135) [android_alarm_manager] Define clang module for iOS

[2137]({{site.repo.organization}}plugins/pull/2137) [connectivity] Define clang module for iOS

[2138]({{site.repo.organization}}plugins/pull/2138) [device_info] Define clang module for iOS

[2144]({{site.repo.organization}}plugins/pull/2144) [android_intent] Define clang module for iOS

[2145]({{site.repo.organization}}plugins/pull/2145) [instrumentation_adapter] Define clang module for iOS

[2146]({{site.repo.organization}}plugins/pull/2146) [local_auth] Define clang module for iOS

[2147]({{site.repo.organization}}plugins/pull/2147) [path_provider] Define clang module for iOS

[2148]({{site.repo.organization}}plugins/pull/2148) [package_info] Define clang module for iOS

[2149]({{site.repo.organization}}plugins/pull/2149) [quick_actions] Define clang module for iOS

[2175]({{site.repo.organization}}plugins/pull/2175) [sensors] Define clang module for iOS

[2176]({{site.repo.organization}}plugins/pull/2176) [shared_preferences] Define clang module for iOS

[2177]({{site.repo.organization}}plugins/pull/2177) [url_launcher] Define clang module for iOS

[2179]({{site.repo.organization}}plugins/pull/2179) [battery] Define clang module for iOS

[2180]({{site.repo.organization}}plugins/pull/2180) [share] Define clang module for iOS

[2182]({{site.repo.organization}}plugins/pull/2182) [google_maps_flutter] Define clang module for iOS, fix analyzer warnings

[2183]({{site.repo.organization}}plugins/pull/2183) [video_player] Define clang module for iOS

[2184]({{site.repo.organization}}plugins/pull/2184) [google_sign_in] Define clang module for iOS

[2185]({{site.repo.organization}}plugins/pull/2185) [webview_flutter] Define clang module for iOS

[2186]({{site.repo.organization}}plugins/pull/2186) Run clang analyzer on iOS and macOS code in CI test when packages change

[40302]({{site.repo.flutter}}pull/40302) Set DEFINES_MODULE for FlutterPluginRegistrant to generate modulemap

[2206]({{site.repo.organization}}plugins/pull/2206) [flutter_plugin_android_lifecycle] Update README with new plugin name

[2207]({{site.repo.organization}}plugins/pull/2207) [flutter_plugin_android_lifecycle] bump e2e depenency to 0.2.1

[2223]({{site.repo.organization}}plugins/pull/2223) [flutter_plugin_android_lifecycle] register the e2e plugin in the example app

[2243]({{site.repo.organization}}plugins/pull/2243) [flutter_plugin_android_lifecycle] Adapt the FlutterLifecycleAdapter to the new embedding API

[44043]({{site.repo.flutter}}pull/44043) Add Android embedding version analytics

[2120]({{site.repo.organization}}plugins/pull/2120) [image_picker] fix crash when aar from 'flutter build aar'

[2168]({{site.repo.organization}}plugins/pull/2168) Add plugin for Android lifecycle in embedding

[2174]({{site.repo.organization}}plugins/pull/2174) [url_launcher] Enable androidx and jetifier in android gradle properties
...
[2119]({{site.repo.organization}}plugins/pull/2119) Add web url launcher
...
[1984]({{site.repo.organization}}plugins/pull/1984) Remove Flutterfire plugins (moved to FirebaseExtended)

[2004]({{site.repo.organization}}plugins/pull/2004) [cirrus] Use flutter create for all_plugins test

[2009]({{site.repo.organization}}plugins/pull/2009) Fix unit test for sensors

[2036]({{site.repo.organization}}plugins/pull/2036) video player version fix

[2055]({{site.repo.organization}}plugins/pull/2055) Point opensource site at new location

[2084]({{site.repo.organization}}plugins/pull/2084) [update] local_auth - intl version

[2112]({{site.repo.organization}}plugins/pull/2112) Run flutter_plugin_tools format

[2141]({{site.repo.organization}}plugins/pull/2141) BugFix: formatHint was meant for network streams.

[2154]({{site.repo.organization}}plugins/pull/2154) Use stable Flutter image as base

[2161]({{site.repo.organization}}plugins/pull/2161) Rename instrumentation_adapter plugin to e2e plugin

[2205]({{site.repo.organization}}plugins/pull/2205) s/flutter_android_lifecycle/flutter_plugin_android_lifecycle/

[2230]({{site.repo.organization}}plugins/pull/2230) Forbid ... implements UrlLauncherPlatform

[2231]({{site.repo.organization}}plugins/pull/2231) [cleanup] Remove AndroidX warning

[2236]({{site.repo.organization}}plugins/pull/2236) Use package import to import files inside lib/ directory.

[2250]({{site.repo.organization}}plugins/pull/2250) Run the publish with the pub version from flutter stable

[2260]({{site.repo.organization}}plugins/pull/2260) Make setMockInitialValues handle non-prefixed keys

[2267]({{site.repo.organization}}plugins/pull/2267) Bump google_maps_flutter pubspec version to match CHANGELOG

[2271]({{site.repo.organization}}plugins/pull/2271) [infra] Ignore analyzer issues in CI

[2280]({{site.repo.organization}}plugins/pull/2280) Add google_sign_in_web plugin.
...
[1985]({{site.repo.organization}}plugins/pull/1985) [android_alarm_manager] Added ability to get id in the callback
...
[2000]({{site.repo.organization}}plugins/pull/2000) [android_intent] add flags option

[2045]({{site.repo.organization}}plugins/pull/2045) [android_intent] Add action_application_details_settings

[2143]({{site.repo.organization}}plugins/pull/2143) [android_intent] Migrate to the new embedding

[2188]({{site.repo.organization}}plugins/pull/2188) [android_intent] Bump the Flutter SDK min version

[2202]({{site.repo.organization}}plugins/pull/2202) [android_intent] componentName must be provided before resolveActivity is called

[2221]({{site.repo.organization}}plugins/pull/2221) [android_intent]remove AndroidX constraint

[2268]({{site.repo.organization}}plugins/pull/2268) [android_intent] Add missing DartDocs
...
[2189]({{site.repo.organization}}plugins/pull/2189) [battery] relax the example app minimal required Flutter version
...
[2057]({{site.repo.organization}}plugins/pull/2057) [Camera] Fixes NullPointerException

[2123]({{site.repo.organization}}plugins/pull/2123) [camera] Fix event type check

[2219]({{site.repo.organization}}plugins/pull/2219) [camera]remove androidx constraint
...
[2212]({{site.repo.organization}}plugins/pull/2212) [connectivity]remove AndroidX constraint

[2262]({{site.repo.organization}}plugins/pull/2262) [connectivity] add more documentations, delete example/README
...
[2022]({{site.repo.organization}}plugins/pull/2022) [instrumentation_adapter] Update README instructions

[2023]({{site.repo.organization}}plugins/pull/2023) [instrumentation_adapter] update boilerplate to use @Rule instead of FlutterTest

[2024]({{site.repo.organization}}plugins/pull/2024) [instrumentation_adapter] update CODEOWNERS

[2051]({{site.repo.organization}}plugins/pull/2051) [instrumentation_adapter] update for release

[2075]({{site.repo.organization}}plugins/pull/2075) [instrumentation_adapter] Migrate example to AndroidX

[2178]({{site.repo.organization}}plugins/pull/2178) [e2e] update README

[2190]({{site.repo.organization}}plugins/pull/2190) [e2e] Update to support new embedder

[2233]({{site.repo.organization}}plugins/pull/2233) [e2e] update README
...
[1702]({{site.repo.organization}}plugins/pull/1702) [google_maps_flutter]Marker drag event

[1767]({{site.repo.organization}}plugins/pull/1767) [google_maps_flutter] Adds support for displaying the traffic layer

[1784]({{site.repo.organization}}plugins/pull/1784) [google_maps_flutter] Allow (de-)serialization of CameraPosition

[1933]({{site.repo.organization}}plugins/pull/1933) [google_maps_flutter] Avoid unnecessary redraws

[2053]({{site.repo.organization}}plugins/pull/2053) [google_maps_flutter] Fix analyzer failures relating to prefer_const_constructors

[2065]({{site.repo.organization}}plugins/pull/2065) [google_maps_flutter] Prefer const constructors.

[2076]({{site.repo.organization}}plugins/pull/2076) [google_maps_flutter] Clone cached elements in GoogleMap

[2108]({{site.repo.organization}}plugins/pull/2108) [google_maps_flutter] Add Projection methods to google_maps

[2113]({{site.repo.organization}}plugins/pull/2113) [google_maps_flutter] Avoid AbstractMethod crash

[2242]({{site.repo.organization}}plugins/pull/2242) [google_maps_flutter] Cast error.code to unsigned long to avoid using NSInteger as %ld format warnings.
...
[2059]({{site.repo.organization}}plugins/pull/2059) [google_sign_in] Fix chained async methods in error handling zones

[2127]({{site.repo.organization}}plugins/pull/2127) [google_sign_in] Fix deprecated API usage issue by upgrading CocoaPod to 5.0

[2244]({{site.repo.organization}}plugins/pull/2244) [google_sign_in] Move plugin to its subdir to allow for federated implementations

[2252]({{site.repo.organization}}plugins/pull/2252) [google_sign_in] Handle new style URLs in GoogleUserCircleAvatar

[2266]({{site.repo.organization}}plugins/pull/2266) [google_sign_in] Port plugin to use the federated Platform Interface
...
[2070]({{site.repo.organization}}plugins/pull/2070) [image_picker] swap width and height when source image orientation is left or right

[2293]({{site.repo.organization}}plugins/pull/2293) [image_picker]fix a crash when a non-image file is picked.
...
[2014]({{site.repo.organization}}plugins/pull/2014) [In_App_Purchase] Avoids possible NullPointerException with background registrations.

[2016]({{site.repo.organization}}plugins/pull/2016) [In_App_Purchase] Improve testability

[2027]({{site.repo.organization}}plugins/pull/2027) [in_app_purchase] Remove skipped driver test

[2215]({{site.repo.organization}}plugins/pull/2215) [in_app_purchase] remove AndroidX constraint
...
[2047]({{site.repo.organization}}plugins/pull/2047) [local_auth] Avoid user confirmation on face unlock

[2111]({{site.repo.organization}}plugins/pull/2111) [local_auth] Api to stop authentication
...
[2218]({{site.repo.organization}}plugins/pull/2218) [package_info]remove AndroidX constraint
...
[1953]({{site.repo.organization}}plugins/pull/1953) [path_provider] add getApplicationLibraryDirectory

[1993]({{site.repo.organization}}plugins/pull/1993) [pathprovider] Fix fall through bug

[2288]({{site.repo.organization}}plugins/pull/2288) [path_provider] Add missing DartDocs
...
[2297]({{site.repo.organization}}plugins/pull/2297) [share] README update
...
[2296]({{site.repo.organization}}plugins/pull/2296) [shared_preferences] Add missing DartDoc
...
[2038]({{site.repo.organization}}plugins/pull/2038) [url_launcher] Removed reference to rootViewController during initialization

[2136]({{site.repo.organization}}plugins/pull/2136) [url_launcher_web] Fix [README.md](http://readme.md/) pubspec example

[2217]({{site.github}}plugins/pull/2217) [url_launcher] Add url_launcher_platform_interface package

[2220]({{site.repo.organization}}plugins/pull/2220) [url_launcher]remove AndroidX constraint

[2228]({{site.repo.organization}}plugins/pull/2228) [url_launcher] Use url_launcher_platform_interface to handle calls

[2237]({{site.repo.organization}}plugins/pull/2237) [url_launcher] Migrate url_launcher_web to the platform interface

[2274]({{site.repo.organization}}plugins/pull/2274) [url_launcher] DartDoc and test improvements
...
[1813]({{site.repo.organization}}plugins/pull/1813) [video-player] add support for content uris as urls

[1998]({{site.repo.organization}}plugins/pull/1998) [video_player] Fix deprecated member use

[2124]({{site.repo.organization}}plugins/pull/2124) [video_player] Move [player dispose] to onUnregistered

[2158]({{site.repo.organization}}plugins/pull/2158) [video_player] Basic test for VideoPlayerController initialization

[2273]({{site.repo.organization}}plugins/pull/2273) [video_player] Add platform interface

[2286]({{site.repo.organization}}plugins/pull/2286) [video_player] Improve DartDocs and test coverage
...
[1996]({{site.repo.organization}}plugins/pull/1996) [webview_flutter] Allow underscores anywhere for Javascript Channel name

[2257]({{site.repo.organization}}plugins/pull/2257) [webview_flutter] Add async NavigationDelegates
