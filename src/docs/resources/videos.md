...
如果你是一个视觉型学习者 (visual learner)，那么这些由
Google 内部和 Flutter 社区制作的 Flutter 的视频可能会对你有所帮助。

Note that many people make Flutter videos. This page shows some that
we like, but there are many others.

我们注意到，其实有很多开发者都制作了 Flutter 视频，
但这个页面仅仅收集了了一些我们相对喜欢的。
...
### Fluttery (社区) 的 Flutter Challenge 系列视频
...
* [Build Native Mobile Apps with Flutter](https://www.udacity.com/course/build-native-mobile-apps-with-flutter--ud905)
  ...
  [使用 Flutter 构建精美的应用](https://cn.udacity.com/course/build-native-mobile-apps-with-flutter--ud905)；
