...
description: >-
  学习如何使用 Flutter 从零开始构建可在移动端、桌面端和 Web 端运行的精美应用。
layout: tutorial
---
...
欢迎来到 Flutter 教程！本教程将教你如何从零开始构建可在移动端、桌面端和 Web 端运行的应用。
...
你将从最基础的地方起步：创建一个空白的 Flutter 应用。在教程结束时，你将完成若干个小型应用，它们将展示 Flutter 开发中的核心特性（以及更多内容！）
...
如果你还不满足以上条件，请先从 [学习路径页面](/learn/pathway) 开始。
