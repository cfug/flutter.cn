...
![Flutter Favorite 项目徽标]({% asset development/packages-and-plugins/FlutterFavoriteLogo.png @path %}){:width="20%"}
...
并不意味着它能够在你的特定情况下保证你的产品质量和适用性——你应该始终针对你的项目情况对 packages 和插件进行评估。
...
他们的一项工作就是认定一个 package 是否满足成为 Flutter Favorite 的质量要求。
...
Flutter Favorite packages 由 Flutter 团队于 pub.dev 上标注。
...
* Flutter Favorite package 的作者可以将 Flutter Favorite 徽标放置在 package 的 GitHub README 中，
  package 在 pub.dev 上的 **Overview**，以及社交媒体上与该 package 相关的帖子。
* 我们鼓励你在社交媒体上使 用 **#FlutterFavorite** 标签。
...
你应该期待 Flutter Favorite packages 列表随着生态系统的持续发展不断壮大和变化。
...
* 使用全新的 [pubspec.yaml 格式][]来明确指出其支持哪些平台。
* 支持 Flutter 的最新稳定版本。
* 对 AndroidX 的支持。
...
[下设委员会]: mailto:csells@google.com
[Flutter Favorite packages]: {{site.pub}}/flutter/favorites
[Package 整体得分]: {{site.pub}}/help
[pubspec.yaml 格式]: /docs/development/packages-and-plugins/developing-packages#plugin-platforms
[经验证的发布者]: {{site.dart-site}}/tools/pub/verified-publishers
