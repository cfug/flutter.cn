...
<img
src="/assets/images/docs/ai-best-practices/crossword-task-list-showing-solved-clues.png"
alt="填字游戏任务列表：已解线索为绿色并带置信度百分比，未解线索为红色">
...
在示例中，我们不必防范伤害，但要防范不完美结果。针对真实数据的广泛测试促成了人在回路（human-in-the-loop）护栏：防止尝试求解无效谜题或冲突解法。这样，Flutter 与 Firebase AI Logic 成为驾驭 LLM 能力、为应用带来独特功能的理想组合。
