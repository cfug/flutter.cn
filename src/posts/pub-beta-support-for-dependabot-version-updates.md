...
大多数开源项目依赖了数百个开源依赖项<sup>[1](https://go2.gdsub.com/ospd "GitHub 文档 - 供应链安全: 大多数开源项目依赖了数百个开源依赖项")</sup>，随着更多开源产品被广泛地使用，这些依赖项带来了一个显而易见安全问题：如果我们使用的依赖项受到攻击和破坏该怎么办？这将让你的用户直接承受供应链攻击带来的风险。供应链攻击是一种新兴的、针对软件开发者和供应商的安全威胁<sup>[2](https://go2.gdsub.com/scad "Microsoft 文档 - 供应链攻击: 供应链攻击是一种新兴的、针对软件开发者和供应商的安全威胁")</sup>，攻击者会通过寻找不安全的网络协议、不受保护的服务器以及不安全的代码等安全漏洞并更改代码，导致使用它的程序在构建和更新的过程中被加入隐藏的恶意代码。
